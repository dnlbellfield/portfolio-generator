        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8"> {{-- Responsive grid for 2 columns --}}
            ...
            <div class="lg:col-span-1"> {{-- Takes one column on large screens --}}
                ...
                <form id="portfolio-form" action="{{ route('portfolio.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <section class="mb-8 p-4 border rounded-md"> {{-- Added styling --}}
                    ...
                    <section id="online-presence-section" class="mb-8 p-4 border rounded-md"> {{-- Added styling and ID --}}
                    ...
                    <section id="skills-section" class="mb-8 p-4 border rounded-md"> {{-- Added styling --}}
                        <h2>Skills</h2>
                        <div class="mb-4">
                    ...
                    <section id="work-experience-section" class="mb-8 p-4 border rounded-md"> {{-- Added styling and ID --}}
                         ...
                         <button type="button" id="add-work-experience-btn" class="mt-4 px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 transition-colors">Add More Work Experience</button>
                     </section>


                    {{-- 8. Education Section --}}
                    <section id="education-section" class="mb-8 p-4 border rounded-md"> {{-- Added styling and ID --}}
                        <h2>Education</h2>
                        ...
                        <button type="button" id="add-education-btn" class="mt-4 px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 transition-colors">Add More Education</button>
                    </section>

                    {{-- 9. Projects Section --}}
                    <section id="projects-section" class="mb-8 p-4 border rounded-md"> {{-- Added styling and ID --}}
                         <h2>Projects</h2>
                         ...
                         <button type="button" id="add-project-btn" class="mt-4 px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 transition-colors">Add More Project</button>
                     </section>

                    {{-- 10. Recommendations/Testimonials Section --}}
                    <section id="recommendations-section" class="mb-8 p-4 border rounded-md"> {{-- Added styling and ID --}}
                        ...
                        <button type="button" id="add-recommendation-btn" class="mt-4 px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 transition-colors">Add More Recommendation</button>
                    </section>

                      {{-- 11. Custom Sections --}}
   <section id="custom-sections-section" class="mb-8 p-4 border rounded-md"> {{-- Added styling and ID --}}
...
<div class="lg:col-span-1"> {{-- Takes the other column on large screens --}}
    ...
    <div id="portfolio-preview">
        <div class="preview-content">
            ...
            {{-- Add placeholder img tags for single image previews here initially in the PREVIEW AREA --}}
            {{-- These will be updated by JavaScript based on file input selection --}}
            <img id="profile-picture-preview" src="" alt="Profile Picture Preview" style="display:none; max-width: 100px; border-radius: 50%; margin: 0 auto 10px;"> {{-- Placeholder with ID --}}
            <img id="about-image-preview" src="" alt="About Image Preview" style="display:none; max-width: 200px; margin-top: 10px;"> {{-- Placeholder with ID --}}

             {{-- Placeholder container for dynamically added project image previews --}}
             {{-- Project images will be shown within the generated project HTML in preview-content --}}

              {{-- Placeholder container for dynamically added custom block image previews --}}
              {{-- Custom images will be shown within the generated custom block HTML in preview-content --}}
        </div>
    </div>
</div> {{-- Closing div for the right column (lg:col-span-1) --}}
